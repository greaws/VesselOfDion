...
public class HorizontalMovementPlayer : Player
{
    ...
    [SerializeField] private LayerMask groundLayer; //! Layer f�r den Boden, im Inspector zuweisen
    ...
    void Start()
    {
        // Debug-Log zur �berpr�fung, ob das Skript aktiviert ist
    ...
    void Update()
    {
        ...
        //Debug.Log($"IsGrounded: {isGrounded}"); //! �berpr�fung, ob der Spieler auf dem Boden ist
    ...
    private void FixedUpdate()
    {
        ...
        // Debug-Log zur �berpr�fung der Bewegung
